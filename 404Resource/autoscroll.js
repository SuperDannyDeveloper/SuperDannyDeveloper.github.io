...
var AutoScroll = function() {
  ...
  checkTop = function() {
    var isPastThreshold = mouseNow.y < self.threshold,
        isAtMin = $window.scrollTop() <= 0;="" if="" (ispastthreshold="" &&="" !isatmin)="" {="" (!scrollingup)="" scrollingup="true;" whenscrollingstarted="new" date();="" }="" var="" v="velocity();" $window.scrolltop($window.scrolltop()="" -="" v);="" triggermousemove(0,="" -v);="" else="" checkbottom="function()" ispastthreshold="mouseNow.y"> viewportNow.height - self.threshold,
